                                    ...
                                    <span class="flex items-center gap-1">
                                        @for($i = 1; $i <= 5; $i++)
                                            @if($i <= floor($averageRating))
                                                <img src="{{ asset('sewa/public/assets/svgs/ic-star.svg') }}"
                                                    class="h-[22px] w-[22px]" alt="star">
                                            @elseif($i - 0.5 <= $averageRating && $averageRating < $i)
                                                <img src="{{ asset('sewa/public/assets/ss.png') }}" class="h-[22px] w-[22px]"
                                                    alt="half star">
                                            @else
                                                <img src="{{ asset('sewa/public/assets/ss.png') }}" class="h-[22px] w-[22px]"
                                                    alt="empty star">
                            ...
                            <div class="flex items-center justify-between gap-4 pt-5 mt-auto">
                                ...
                                <div class="w-full max-w-[70%]">
                                    <div class="p-1 rounded-full bg-primary group">
                                        @if($item->available)
                                            <a href="{{ route('bookings.create', parameters: ['item_slug' => $item->slug]) }}"
                                                class="btn-primary">
                                                <p>Rent Now</p>
                                        ...
                                        @else
                                            <div
                                                class="btn-primary bg-gray-400 cursor-not-allowed text-white flex items-center justify-center py-2 px-4 rounded-full">
                                                <p>On Rent</p>
                                            </div>
                                        @endif
                        ...
                        <div class="flex items-center justify-between">
                            ...
                            <div class="flex items-center gap-3">
                                <div class="flex items-center gap-1">
                                    @for($i = 1; $i <= 5; $i++)
                                        @if($i <= floor($averageRating))
                                            <img src="{{ asset('sewa/public/assets/svgs/ic-star.svg') }}" class="h-6 w-6"
                                                alt="star">
                                        @elseif($i - 0.5 <= $averageRating && $averageRating < $i)
                        ...
                        <div class="bg-white p-5 rounded-3xl sticky top-6">
                            ...
                            @else
                                <div class="text-center py-6">
                                    ...
                                    @else
                                        <img src="{{ asset('sewa/public/assets/svgs/file-list-3-line.svg') }}"
                                            class="h-12 w-12 mx-auto mb-4" alt="No bookings">
